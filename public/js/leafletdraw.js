!(function (t, e, i) {
    ...
    (L.drawVersion = "1.0.4"),
        ...
        (L.drawLocal = {
            draw: {
                toolbar: {
                    actions: { title: "Cancel drawing", text: "Annuleer" },
                    finish: { title: "Finish drawing", text: "Voltooi" },
                    undo: { title: "Delete last point drawn", text: "Verwijder laatste punt" },
                    buttons: { polyline: "Draw a polyline", polygon: "Draw a polygon", rectangle: "Draw a rectangle", circle: "Draw a circle", marker: "Draw a marker", circlemarker: "Draw a circlemarker" },
                },
                handlers: {
                    ...
                    polygon: { tooltip: { start: "Klik om het eerste punt te plaatsen", cont: "Klik om het volgende punt te plaatsen", end: "Klik op het eerste punt om de grens te sluiten" } },
            ...
            edit: {
                toolbar: {
                    actions: { save: { title: "Save changes", text: "Save" }, cancel: { title: "Cancel editing, discards all changes", text: "Cancel" }, clearAll: { title: "Clear all layers", text: "Clear All" } },
                ...
                readableArea: function (e, i, o) {
                    ...
                    return (
                        i
                            ...
                            : ((e /= 0.836127),
                              (a = e >= 3097600 ? L.GeometryUtil.formattedNumber(e / 3097600, o.mi) + " mi²" : e >= 4840 ? L.GeometryUtil.formattedNumber(e / 4840, o.ac) + " hectare" : L.GeometryUtil.formattedNumber(e, o.yd) + " yd²")),
                        a
                    );
                },
